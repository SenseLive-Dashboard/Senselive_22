...
// controller path
const controller = require("../controller/controller_main.js");
...
router.get('/signupone', controller.signupone);

// signupTwo route
router.post('/signuptwo', controller.signuptwo);
router.get('/signuptwo', controller.signuptwo);
...
router.get('/forgotPasswordOne', controller.forgotPasswordOne);


// forgotPasswordTwo route
router.post('/forgotPasswordTwo', controller.forgotPasswordTwo);
router.get('/forgotPasswordTwo', controller.forgotPasswordTwo);



// forgotPasswordThree route
router.post('/forgotPasswordThree', controller.forgotPasswordThree);
router.get('/forgotPasswordThree', controller.forgotPasswordThree);
...
// bar_graph 
// router.get('/baryear/:m_id',controller.bar_year)
// router.get('/barmonth/:m_id',controller.bar_month)
// router.get('/barweek/:m_id',controller.bar_week)
router.get('/bar-graph/:m_id',controller.bar_graph)

//Line Grah
router.get('/line/:graph',controller.line)
